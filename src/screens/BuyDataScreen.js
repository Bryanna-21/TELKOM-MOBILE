...
export default function BuyDataScreen({ navigation }) {{
  ...
  return (
    <SafeAreaView style={{styles.container}}>
      <View style={{styles.header}}>
        ...
        <Text style={{styles.headerTitle}}>Buy Data</Text><View style={{width:26}} />
      </View>
      <View style={{styles.content}}>
        <Icon name="data-usage" size={{56}} color={{COLORS.primary}} />
        ...
        <TextInput style={{styles.input}} value={{value}} onChangeText={{setValue}}
          placeholder="Data bundle / amount" placeholderTextColor="#999" keyboardType="numeric" />
