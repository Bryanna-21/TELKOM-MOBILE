...
export default function LipaTkashScreen({ navigation }) {{
  ...
  return (
    <SafeAreaView style={{styles.container}}>
      <View style={{styles.header}}>
        ...
        <Text style={{styles.headerTitle}}>Lipa T-Kash</Text><View style={{width:26}} />
      </View>
      <View style={{styles.content}}>
        <Icon name="qr-code" size={{56}} color={{COLORS.primary}} />
        <Text style={{styles.title}}>Lipa T-Kash</Text>
        <Text style={{styles.subtitle}}>Secure, simple and ready for backend integration.</Text>
        <TextInput style={{styles.input}} value={{value}} onChangeText={{setValue}}
          placeholder="Till or merchant number" placeholderTextColor="#999" keyboardType="numeric" />
