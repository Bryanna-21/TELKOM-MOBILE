...
export default function ZiadaRewardsScreen({ navigation }) {{
  ...
  return (
    <SafeAreaView style={{styles.container}}>
      <View style={{styles.header}}>
        ...
        <Text style={{styles.headerTitle}}>Ziada Rewards</Text><View style={{width:26}} />
      </View>
      <View style={{styles.content}}>
        <Icon name="stars" size={{56}} color={{COLORS.primary}} />
        <Text style={{styles.title}}>Ziada Rewards</Text>
        <Text style={{styles.subtitle}}>Secure, simple and ready for backend integration.</Text>
        <TextInput style={{styles.input}} value={{value}} onChangeText={{setValue}}
          placeholder="Reward code or action" placeholderTextColor="#999" keyboardType="default" />
